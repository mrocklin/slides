...
*  Complex algorithms common in analysis but awkward in a database
*  We have widespread tools and widespread intuition
    * Make
    * Luigi
*  But these are mostly used for high-latency bulk operations
*  However, task scheduling also proved out in new numeric libraries
...
*  Dask contains high-level APIs that mimic successful PyData projects
