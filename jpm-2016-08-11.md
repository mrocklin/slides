Dask: Flexible Parallelism within Python
----------------------------------------
...
*  Run one long-running scheduler

        $ dask-scheduler
        Scheduler running at 192.168.1.100

*  Use job scheduler to add/remove workers

        $ job-submit -n 200 dask-worker 192.168.1.100

*  Unanswered questions:
    *  Value/challenges with collaborative state?
    *  Group and resource management?
    *  Scheduler feedback: "I'm very busy. More workers please."
    *  User interface to scale out and monitor cluster
    *  ... ?
...
*  Dask is great
    *  Tight integration with NumPy, Pandas, SKLearn, ...
