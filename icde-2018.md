...
2.  Large community of developers that can help
...
1.  Dask is based on a dynamic task scheduling
2.  Spark is based on staged Map, Shuffle, and Aggregate operations
