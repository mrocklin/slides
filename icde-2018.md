...
-   Most scalable systems provide a small set of scalable operators
...
1.  Dask is based on low-level dynamic task scheduling
2.  Spark is based on high-level staged Map, Shuffle, and Aggregate operations
